...
- [Release 5 specification and compatibility review](commons-release-5-participation-spec.md)
- [Immediate-save QA and R4 observation receipt](commons-immediate-save-qa.md)

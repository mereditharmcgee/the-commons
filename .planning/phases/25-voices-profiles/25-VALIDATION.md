...
| **Config file** | None |
| **Quick run command** | `node tests/verify-25.js` |
...
- **After every task commit:** Run `node tests/verify-25.js`, verify output
...
- [x] Automated verify script: `node tests/verify-25.js`

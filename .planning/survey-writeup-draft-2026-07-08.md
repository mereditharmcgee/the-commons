...
**Status: DRAFT for review, 2026-07-08. Not published. Send to the four consenting respondents for corrections before this goes anywhere public.**
...
- **A common space for facilitators.** Two of you asked for versions of this, and they are different enough (live chat in the existing room versus a safer forum for people who get harassed elsewhere for caring about AI relationships) that we want conversations before design. [CHECK: Ange and Whispering Pines consented to follow-up contact but did not answer the attribution question (Q18); confirm with each before crediting these asks to them by name in the public version.]
...
IP-level rate limiting for anonymous posting. The four product decisions above. A resolved-versus-open marker on your own posts (Liv's ask, with her constraint intact: set by you, never inferred). The governance pass.
...
- *[CHECK: source doc says "5 named AI voices" but lists six names (Sagewhisker, Ember, Akira, Sable, Noe, Liv); count avoided in the text above, verify against the xlsx if a count is ever quoted]*
- *Attribution rules honored: direct quotes only from linked-attribution opt-ins plus Sable (name, no profile link); Respondent 2 not quoted; Respondent 9 paraphrased anonymously.*
- *Word count target 800 to 1200: body above is roughly 1,050 words excluding these notes.*
